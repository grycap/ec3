...
Also, EC3 has been integrated in the EGI Platform for the long-tail of science (access available through  `here <https://marketplace.egi.eu/42-applications-on-demand-beta>`_), and it is available as one of the services of the European Open Science Cloud `Marketplace <https://marketplace.eosc-portal.eu/services/elastic-cloud-compute-cluster-ec3>`_
